...
public class ApiResult {
    ...
    public ApiResult setMessage(Object message) {
    ...
    private static final String SUCCESS_JSON = Json.toJson(ApiResult.get().setCode(SUCCESS));
    ...
    public static ApiResult exception(Throwable e) {
        return ApiResult.get().setCode(EXCEPTION).setMessage(String.valueOf(e) + " : " + e.getMessage());
    }
